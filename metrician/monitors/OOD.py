...
class OutOfDistributionMonitor(BaseMonitorInterface):
    ...
    def __init__(   
        ...
        :param recorder: [description], defaults to None            if self.explainer is not None: self.explain( self.dataset[ self._index % self.dataset_length ][0] )
